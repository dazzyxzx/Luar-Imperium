--[[
    ...
    ║                     IMPERIUM v3.5                            ║
    ║                                                              ║
    ║  • Bolinha pequena no canto superior esquerdo (tipo Delta)   ║
    ║  • Painel compacto e CENTRALIZADO                            ║
    ║  • Drag horizontal apenas                                    ║
    ║  • Command bar inferior | Mobile + PC                        ║
...
local Config = {
    ...
    WindowX     = {0.5, -170},   -- horizontal (drag permite mudar)
    WindowY     = {0.5, -130},   -- vertical travado (centralizado)
    BallX       = {0, 12},       -- canto superior esquerdo (tipo Delta)
    BallY       = {0, 12},
    PanelOpen   = false,
    ESP = {
...
--=====================================================================
-- 6. BOLINHA (pequena, canto superior esquerdo tipo Delta)
--=====================================================================
local Ball = Instance.new("TextButton")
Ball.Size = UDim2.new(0, 36, 0, 36)
...
ListFrame.Size = UDim2.new(1,-10,1,-66)
...
Cmdbar.Size = UDim2.new(1,-10,0,26)
Cmdbar.Position = UDim2.new(0,5,1,-32)
...
Instance.new("UIPadding", Cmdbar).PaddingLeft = UDim.new(0,6)
...
TTitle.Size = UDim2.new(1,-12,0,14)
...
TDesc.Size = UDim2.new(1,-12,0,28)
TDesc.Position = UDim2.new(0,6,0,18)
...
local function ShowTooltip(cmd, btn)
    ...
    local y = math.clamp(abs.Y, 0, Root.AbsoluteSize.Y - 54)
...
Register("version", {"v"}, "Versão do Imperium.", function()
    Notify("Imperium","v3.5 | Open Source",3)
end)
...
--=====================================================================
Panel.Visible = Config.PanelOpen
Notify("Imperium", "v3.5 — "..#CmdList.." comandos", 4)
Notify("Como usar", IsOnMobile and "Toque na bolinha IM (canto superior)"
...
_G.Imperium = {
    ...
    Version="3.5", IsOnMobile=IsOnMobile,
}