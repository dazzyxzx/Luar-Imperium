if IY_LOADED and not _G.IY_DEBUG then
	-- error("Imperium is already running!", 0)
	return
end
...
if makefolder and isfolder and writefile and isfile then
	pcall(function() -- good executor trust
		local assets = "https://raw.githubusercontent.com/SEU_USER/Imperium-assets/refs/heads/main/"
...
Title.TextSize = 18
Title.Text = "Imperium v" .. currentVersion
...
CMDsF.ScrollBarImageColor3 = Color3.fromRGB(60,60,60)
...
SettingsHolder.ScrollBarImageColor3 = Color3.fromRGB(60,60,60)
...
PrefixBox.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
...
StayOpen.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
Title_3.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
IntroBackground.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
...
Credits.Text = "Math (Luar) // Imperium"
...
Delete.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
Holder_2.ScrollBarImageColor3 = Color3.fromRGB(60,60,60)
...
Delete_2.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
...
Dark_3.Active = true
Dark_3.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
BindTo.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
BindTriggerSelect.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
Add_2.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
ClickTP.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
ClickDelete.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
Select_2.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
...
Cmdbar_2.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
Cmdbar_3.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
CreateToggle.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
shadow_2.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
Delete_5.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
Part.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
Holder_4.ScrollBarImageColor3 = Color3.fromRGB(60,60,60)
...
Example_4.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
Delete_6.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
...
AliasesFrame.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
...
Delete_3.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
Holder_3.ScrollBarImageColor3 = Color3.fromRGB(60,60,60)
...
Example_3.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
Delete_4.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
...
PluginsFrame.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
...
Close_4.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
Add_3.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
Holder_5.ScrollBarImageColor3 = Color3.fromRGB(60,60,60)
...
Example_5.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
Delete_7.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
...
Dark_2.Active = true
Dark_2.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
AddPlugin.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
FileName.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
shadow_3.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
PluginsHint.Text = "Download plugins from the IY Discord (discord.gg/BDCajDWXj8)"
...
background_4.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
...
ChoosePart.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
shadow_4.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
reference = (function()
	...
	inviteButton.MouseButton1Click:Connect(function()
		if everyClipboard then
			toClipboard("https://discord.gg/BDCajDWXj8")
		...
		inviteButton.Text = "Copy Discord Invite Link (https://discord.gg/BDCajDWXj8)"
	end)
	dragGUI(main)
	main.Parent = ScaledHolder
...
currentShade1 = Color3.fromRGB(30, 30, 30)
currentShade2 = Color3.fromRGB(40, 40, 40)
currentShade3 = Color3.fromRGB(60, 60, 60)
currentText1 = Color3.new(1, 1, 1)
currentText2 = Color3.new(0, 0, 0)
currentScroll = Color3.fromRGB(60,60,60)
...
ColorsButton.MouseButton1Click:Connect(function()
	...
	if not colorpickerOpen then
		...
		Npicker.Default = function(self)
			updateColors(Color3.fromRGB(30, 30, 30),shade1)
			updateColors(Color3.fromRGB(40, 40, 40),shade2)
			updateColors(Color3.fromRGB(60, 60, 60),shade3)
			updateColors(Color3.new(1, 1, 1),text1)
			updateColors(Color3.new(0, 0, 0),text2)
			updateColors(Color3.fromRGB(60,60,60),scroll)
			wait()
			updatesaves()
		end
	else
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- Imperium Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Invite to the Imperium discord server.'}
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/SEU_USER/Imperium/master/source'))()")
	end
end)
...
addcmd('discord', {'support', 'help'}, function(args, speaker)
	if everyClipboard then
		toClipboard('https://discord.com/invite/BDCajDWXj8')
		notify('Discord Invite', 'Copied to clipboard!\ndiscord.gg/BDCajDWXj8')
	else
		notify('Discord Invite', 'discord.gg/BDCajDWXj8')
	end
	if httprequest then
		httprequest({
...
addcmd('keepiy', {}, function(args, speaker)
	if queueteleport then
		KeepInfYield = true
		notify('KeepIY','Imperium will now run after you teleport')
		updatesaves()
	else
...
addcmd('unkeepiy', {}, function(args, speaker)
	if queueteleport then
		KeepInfYield = false
		notify('KeepIY','Imperium will no longer run after you teleport')
		updatesaves()
	else
		notify('Incompatible Exploit','Your exploit does not support this command (missing queue_on_teleport)')
	end
...
addcmd("f3x", {"fex"}, function(args, speaker)
	loadstring(game:HttpGet("https://raw.githubusercontent.com/SEU_USER/Imperium-assets/refs/heads/main/f3x.lua"))()
end)
...
addcmd("wallwalk", {"walkonwalls"}, function(args, speaker)
	loadstring(game:HttpGet("https://raw.githubusercontent.com/SEU_USER/Imperium-assets/main/wallwalker.lua"))()
end)
...
addcmd('oldconsole',{},function(args, speaker)
	...
	local _, str = pcall(function()
		return game:HttpGet("https://raw.githubusercontent.com/SEU_USER/Imperium-assets/main/console.lua", true)
	end)
...
addcmd("moondex", {"mdex"}, function(args, speaker)
    notify("Loading", "Hold on a sec")
    loadstring(game:HttpGet("https://raw.githubusercontent.com/SEU_USER/Imperium-assets/main/dex.lua"))()
end)
...
addcmd("simplespy", {"sspy"}, function(args, speaker)
    ...
    loadstring(game:HttpGet("https://raw.githubusercontent.com/SEU_USER/Imperium-assets/main/SimpleSpyV3/main.lua"))()
end)

addcmd('audiologger',{'alogger'},function(args, speaker)
	notify("Loading",'Hold on a sec')
	loadstring(game:HttpGet(('https://raw.githubusercontent.com/SEU_USER/Imperium-assets/main/audiologger.lua'),true))()
end)
...
if IsOnMobile then
	...
	QuickCapture.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
	QuickCapture.BackgroundTransparency = 0.14
	QuickCapture.Position = UDim2.new(0.489, 0, 0, 0)
	QuickCapture.Size = UDim2.new(0, 32, 0, 33)
	QuickCapture.Font = Enum.Font.SourceSansBold
	QuickCapture.Text = "IM"
...
task.spawn(function()
	local success, latestVersionInfo = pcall(function() 
		local versionJson = game:HttpGet("https://raw.githubusercontent.com/SEU_USER/Imperium/master/version")
...
local SDRovalra = "https://apis.rovalra.com"
local SDGeo = "https://ipapi.co/json/"
local SD = {
    Running=false, Refreshing=false, Scanning=false, LoadedOnce=false,
    Servers={}, Rows={}, Datacenters={}, Origin=nil,
    CityRank={}, CityPing={}, ServerRegion={},
    SortMode="Closest Region", HideFull=true,
    Interval=20, PingCoef=1, PingBase=30, RealPing=nil,
    Built=false,
}
local SDColors = {
    ...
    Join    = Color3.fromRGB(60, 130, 90),
    Share   = Color3.fromRGB(60, 60, 90),
    Btn     = Color3.fromRGB(60, 60, 60),
}
local function SDGet(url)
    local ok, status, body = pcall(function()
        if request then local r=request({Url=url,Method="GET"}) return r.StatusCode, r.Body
        elseif http_request then local r=http_request({Url=url,Method="GET"}) return r.StatusCode, r.Body
        elseif syn and syn.request then local r=syn.request({Url=url,Method="GET"}) return r.StatusCode, r.Body end
        return 200, game:HttpGet(url)
    end)
    if ok then return status, body end
    return nil, nil
end
local function SDDecode(body)
    if not body then return nil end
    local ok, d = pcall(function() return HttpService:JSONDecode(body) end)
    if not ok then return nil end
    return d
end
local function SDHav(a1,o1,a2,o2)
    local R=6371
    local dA=math.rad(a2-a1)
    local dO=math.rad(o2-o1)
    local x=math.sin(dA/2)^2+math.cos(math.rad(a1))*math.cos(math.rad(a2))*math.sin(dO/2)^2
    return R*2*math.atan2(math.sqrt(x),math.sqrt(1-x))
end
local function SDLatLon(loc)
    if not loc then return nil,nil end
    if loc.latLong then return tonumber(loc.latLong[1]),tonumber(loc.latLong[2]) end
    if loc.latitude and loc.longitude then return tonumber(loc.latitude),tonumber(loc.longitude) end
    if loc.lat and loc.lon then return tonumber(loc.lat),tonumber(loc.lon) end
    return nil,nil
end
local function SDEst(d) return math.floor(SD.PingCoef*math.sqrt(d)+SD.PingBase) end
local function SDFetchDCs()
    local _, body = SDGet(SDRovalra.."/v1/datacenters/list")
    local d = SDDecode(body)
    if not d then return {} end
    local l={}
    for _, dc in ipairs(d) do
        local loc=dc.location
        if loc and loc.city then
            local la,lo=SDLatLon(loc)
            if la and lo then table.insert(l,{City=loc.city,Lat=la,Lon=lo}) end
        end
    end
    return l
end
local function SDFetchCity()
    local url = string.format("%s/v1/servers/details?place_id=%d&server_ids=%s",
        SDRovalra, PlaceId, HttpService:UrlEncode(game.JobId))
    local _, body = SDGet(url)
    local d = SDDecode(body)
    if not d or not d.servers or not d.servers[1] then return nil end
    return d.servers[1].city
end

local function SDFetchOrigin()
    local _, body = SDGet(SDGeo)
    local d = SDDecode(body)
    if not d then return nil end
    local la,lo=SDLatLon(d)
    if not la or not lo then return nil end
    return {Lat=la, Lon=lo}
end
local function SDGetPing()
...
local function SDCalibrate()
    SD.PingCoef=1 SD.PingBase=30 SD.RealPing=nil
    if not SD.Origin then return end
    local city = SDFetchCity()
    if not city then return end
    local rp = SDGetPing()
    for _, dc in ipairs(SD.Datacenters) do
        if dc.City == city then
            if rp then
                SD.RealPing = math.floor(rp)
                local dist = SDHav(SD.Origin.Lat, SD.Origin.Lon, dc.Lat, dc.Lon)
                if dist > 200 then
                    local c = (rp-30)/math.sqrt(dist)
                    if c==c and c>0 then SD.PingCoef = math.clamp(c,0.3,3) end
                end
            end
            break
        end
...
local function SDRecompute()
    SD.CityRank={} SD.CityPing={}
    if not SD.Origin then return end
    local r={}
    for _, dc in ipairs(SD.Datacenters) do
        table.insert(r,{City=dc.City, Dist=SDHav(SD.Origin.Lat, SD.Origin.Lon, dc.Lat, dc.Lon)})
    end
    table.sort(r, function(a,b) return a.Dist<b.Dist end)
    for i,e in ipairs(r) do
        SD.CityRank[e.City]=i
        SD.CityPing[e.City]=SDEst(e.Dist)
    end
end
local function SDScanRegions()
    local o={}
    for _, dc in ipairs(SD.Datacenters) do table.insert(o,dc) end
    table.sort(o, function(a,b)
        return (SD.CityRank[a.City] or math.huge) < (SD.CityRank[b.City] or math.huge)
    end)
    for _, dc in ipairs(o) do
        if not SD.Running then return end
        local city = HttpService:UrlEncode(dc.City)
        local cur = "0"
        local p = 0
        while cur and p<2 do
            local url = string.format("%s/v1/servers/region?place_id=%d&city=%s&limit=100&cursor=%s",
                SDRovalra, PlaceId, city, HttpService:UrlEncode(cur))
            local _, body = SDGet(url)
            p = p+1
            local d = SDDecode(body)
            if not d or not d.servers then break end
            for _, e in ipairs(d.servers) do
                if e.server_id then SD.ServerRegion[e.server_id]=dc.City end
            end
            cur = d.next_cursor
            if not cur or cur=="" or cur=="0" then break end
            task.wait(0.2)
        end
        task.wait(0.2)
    end
end
local function SDFetchServers()
    local srv={}
    local cur=""
    for _=1,25 do
        local url = string.format(
            "https://games.roblox.com/v1/games/%d/servers/Public?sortOrder=Asc&limit=100&cursor=%s",
            PlaceId, HttpService:UrlEncode(cur))
        local status, body = SDGet(url)
        if status == 429 then return srv end
        local d = SDDecode(body)
        if not d or not d.data then break end
        for _, e in ipairs(d.data) do
            table.insert(srv,{Id=e.id, Playing=e.playing or 0, MaxPlayers=e.maxPlayers or 0})
        end
        cur = d.nextPageCursor
        if not cur or cur=="" then break end
        task.wait()
    end
    return srv
end
local function SDBuildList()
    local l={}
    for _, s in ipairs(SD.Servers) do
        if s.Playing > 0 then
            local inc=true
            if SD.HideFull and s.Playing>=s.MaxPlayers and s.Id~=game.JobId then inc=false end
            if inc then
                s.RegionCity = SD.ServerRegion[s.Id]
                s.RegionRank = s.RegionCity and SD.CityRank[s.RegionCity]
                if s.Id==game.JobId and SD.RealPing then
                    s.RegionPing = SD.RealPing
                    s.IsReal = true
                else
                    s.RegionPing = s.RegionCity and SD.CityPing[s.RegionCity]
                    s.IsReal = false
                end
                table.insert(l,s)
            end
    ...
    table.sort(l, function(a,b)
        if a.Id==game.JobId or b.Id==game.JobId then return a.Id==game.JobId end
        if SD.SortMode=="Most Players" then return a.Playing>b.Playing end
        if SD.SortMode=="Fewest Players" then return a.Playing<b.Playing end
        if SD.SortMode=="Closest Region" then
            local ra,rb = a.RegionRank or math.huge, b.RegionRank or math.huge
            if ra==rb then return a.Playing<b.Playing end
            return ra<rb
        end
...
local function SDJoin(id)
    local ok, err = pcall(function()
        TeleportService:TeleportToPlaceInstance(PlaceId, id, LocalPlayer)
    end)
    if not ok then notify("Server Directory", "Erro: "..tostring(err)) end
end
local function SDShare(id)
    local snip = string.format('game:GetService("TeleportService"):TeleportToPlaceInstance(%d,"%s",game:GetService("Players").LocalPlayer)', PlaceId, id)
    if everyClipboard then
        everyClipboard(snip)
        notify("Server Directory","Snippet copiado")
    else
        notify("Server Directory","Clipboard não suportado")
    end
end

local function SDBuildUI()
    if SD.Built then return end
    SD.Built = true
    local f = Instance.new("Frame")
    f.Name = "SD_Panel"
    f.Size = UDim2.new(0, 360, 0, 420)
    f.Position = UDim2.new(0.5, -180, 0.5, -210)
    f.BackgroundColor3 = SDColors.Bg
    f.BorderSizePixel = 0
    f.Visible = false
    f.ZIndex = 900
    f.Active = true
    ...
    hdr.BackgroundColor3 = SDColors.Header
    hdr.BorderSizePixel = 0
    hdr.Parent = f
    Instance.new("UICorner", hdr).CornerRadius = UDim.new(0, 8)

    local filler = Instance.new("Frame")
    filler.Size = UDim2.new(1, 0, 0, 8)
    filler.Position = UDim2.new(0, 0, 1, -8)
    filler.BackgroundColor3 = SDColors.Header
    ...
    tl.BackgroundTransparency = 1
    tl.Text = "Server Directory"
    tl.TextColor3 = SDColors.Accent
    ...
    closeBtn.BackgroundColor3 = SDColors.Btn
    closeBtn.BorderSizePixel = 0
    closeBtn.Text = "×"
    closeBtn.TextColor3 = SDColors.Text
    ...
    rb.Size = UDim2.new(0, 62, 0, 20)
    rb.Position = UDim2.new(1, -68, 0, 4)
    rb.BackgroundColor3 = SDColors.Btn
    rb.BorderSizePixel = 0
    rb.Text = "Refresh"
    rb.TextColor3 = SDColors.Text
    ...
    rb.MouseButton1Click:Connect(function()
        SD.Refreshing = false
        task.spawn(function()
            SD.Servers = SDFetchServers()
            SDRefreshList()
        end)
    end)

    local ff = Instance.new("Frame")
    ff.Size = UDim2.new(1, -16, 0, 26)
    ff.Position = UDim2.new(0, 8, 0, 74)
    ff.BackgroundTransparency = 1
    ff.Parent = f

    local function mkF(text, x, w, cb)
        local b = Instance.new("TextButton")
        b.Size = UDim2.new(0, w, 1, 0)
        b.Position = UDim2.new(0, x, 0, 0)
        b.BackgroundColor3 = SDColors.Btn
        b.BorderSizePixel = 0
        b.Text = text
        b.TextColor3 = SDColors.Text
    ...
    mkF("Closest", 0, 82, function() SD.SortMode = "Closest Region" SDRefreshList() end)
    mkF("Most", 86, 60, function() SD.SortMode = "Most Players" SDRefreshList() end)
    mkF("Fewest", 150, 60, function() SD.SortMode = "Fewest Players" SDRefreshList() end)
    local hb = mkF("Hide: ON", 214, 74, function()
        SD.HideFull = not SD.HideFull
        hb.Text = "Hide: "..(SD.HideFull and "ON" or "OFF")
        SDRefreshList()
    end)

    local sc = Instance.new("ScrollingFrame")
    sc.Size = UDim2.new(1, -16, 1, -116)
    sc.Position = UDim2.new(0, 8, 0, 106)
    sc.BackgroundTransparency = 1
    sc.BorderSizePixel = 0
    sc.CanvasSize = UDim2.new(0, 0, 0, 0)
    sc.ScrollBarThickness = 5
    sc.ScrollBarImageColor3 = SDColors.Accent
    sc.Parent = f
    SD.Scroll = sc
...
function SDRefreshList()
    if not SD.Scroll then return end
    local l = SDBuildList()
    for _, r in pairs(SD.Rows) do if r and r.Parent then r.Visible = false end end

    for i, s in ipairs(l) do
        local row = SD.Rows[s.Id]
        if not row or not row.Parent then
            row = Instance.new("Frame")
            row.Size = UDim2.new(1, -6, 0, 52)
            row.BackgroundColor3 = SDColors.Card
            row.BorderSizePixel = 0
            row.Parent = SD.Scroll
            ...
            jb.Size = UDim2.new(0, 48, 0, 22)
            jb.Position = UDim2.new(1, -104, 0, 15)
            jb.BackgroundColor3 = SDColors.Join
            ...
            jb.Parent = row
            Instance.new("UICorner", jb).CornerRadius = UDim.new(0, 4)

            local sb = Instance.new("TextButton")
            sb.Size = UDim2.new(0, 48, 0, 22)
            sb.Position = UDim2.new(1, -54, 0, 15)
            sb.BackgroundColor3 = SDColors.Share
            ...
            jb.MouseButton1Click:Connect(function() SDJoin(s.Id) end)
            sb.MouseButton1Click:Connect(function() SDShare(s.Id) end)

            SD.Rows[s.Id] = row
            SD.Rows[s.Id.."_i"] = info
            SD.Rows[s.Id.."_s"] = sub
        end

        local t = string.format("%d/%d players", s.Playing, s.MaxPlayers)
        local rl = "Regiao desconhecida"
        if s.RegionCity then
            if s.RegionPing then
                if s.IsReal then rl = string.format("%s - %d ms (atual)", s.RegionCity, s.RegionPing)
                else rl = string.format("%s - ~%d ms", s.RegionCity, s.RegionPing) end
            else rl = s.RegionCity end
        end
        if s.Id == game.JobId then t = "* " .. t .. " (atual)" end

        SD.Rows[s.Id.."_i"].Text = t
        SD.Rows[s.Id.."_s"].Text = rl
        row.LayoutOrder = i
        row.Visible = true
    end

    local ly = SD.Scroll:FindFirstChildOfClass("UIListLayout")
    if ly then SD.Scroll.CanvasSize = UDim2.new(0, 0, 0, ly.AbsoluteContentSize.Y + 8) end
    if SD.StatusLbl then
        SD.StatusLbl.Text = string.format("%d servidores - %s", #l, os.date("%I:%M:%S %p"))
    end
end

local function SDCycle()
    if SD.Refreshing then return end
    SD.Refreshing = true
    local got = 0
    pcall(function()
        local ss = SDFetchServers()
        got = #ss
        if got > 0 then SD.Servers = ss end
    end)
    if got > 0 then SD.Interval = 20
    else SD.Interval = math.min(SD.Interval * 2, 180) end
    SDRefreshList()
    SD.Refreshing = false
end

local function SDStartLoops()
    if SD.Running then return end
    SD.Running = true
    task.spawn(function()
        while SD.Running do
            SDCycle()
            task.wait(SD.Interval)
        end
    end)
    task.spawn(function()
        while SD.Running do
            if not SD.Scanning and #SD.Datacenters > 0 then
                SD.Scanning = true
                pcall(SDScanRegions)
                SD.Scanning = false
                SDRefreshList()
...
local function SDOpen()
    SDBuildUI()
    if not SD.Frame then return end
    SD.Frame.Visible = not SD.Frame.Visible
    if not SD.Frame.Visible then return end
    if not SD.LoadedOnce then
        SD.LoadedOnce = true
        task.spawn(function()
            if SD.StatusLbl then SD.StatusLbl.Text = "Carregando dados..." end
            SD.Datacenters = SDFetchDCs()
            SD.Origin = SDFetchOrigin()
            if not SD.Origin then
                local city = SDFetchCity()
                if city then
                    for _, dc in ipairs(SD.Datacenters) do
                        if dc.City == city then
                            SD.Origin = {Lat = dc.Lat, Lon = dc.Lon}
                            break
                        end
                    end
                end
...
addcmd("serverdirectory", {"sd", "servers", "svd"}, function(args, speaker)
    SDOpen()
end)
